...
void setup() {   
  ...
  //  while(!Serial.available()) SPARK_WLAN_Loop();
   ...
   // just for windows computers. Serial waits for a key to be pushed
}
 ...
 */
 ...
 /*
   if (pixy.blocks[0].signature == 138){     // why 10 and 138???          //    octal numbers so color code 12 = 14-octal   color code 123 = 173-octal, 1234 = 2322-Octal 
      
          Serial.println("Wow 138");                                                // http://www.rapidtables.com/convert/number/decimal-to-octal.htm
   ...
   if (pixy.blocks[0].signature == 19){    
          Serial.println("Great 19");                                               
      }  
            
    
   if (pixy.blocks[0].signature == 154){    
          Serial.println("Great 154");                                               
      }
    ...
    if (pixy.blocks[0].signature == 138){    
